...
this addon is intended to be installed via the steam workshop. however, for development or direct use:
    ...
    place the evil_footsteps folder (containing addon.json and the lua folder) into your garrysmod/addons/ directory.

    ensure the addon.json tags and type match the compiler's requirements for successful packing.
